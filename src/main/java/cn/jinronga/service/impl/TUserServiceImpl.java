...
import cn.jinronga.dao.TUserDao;
...
public class TUserServiceImpl implements TUserService {
    ...
    @Override
    public List<TUser> findUserByName(String username) {
        //条件查询
        TUser tUser = new TUser();
        tUser.setUsername(username);

        return tUserDao.queryAll(tUser);
    }

    @Override
    public List<TUser> getUsersByRoleId(Integer rId) {

        return tUserDao.getUsersByRoleId(rId);
    }
}
